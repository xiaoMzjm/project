package com.zjm.wxlogin.wrapper;
    ...
    public WxRequireLoginResultDTO requireWxForLogin(String code) throws Exception{
        ...
        for(int i = 0 ; i < 2 ; i++) {
            try {
                ...
                if(i == 1) {
                    WxLoginVerifyUtil.isTrue(false , WxLoginExceptionEnums.LOGIN_REQUIRED_LOGIN_ERROR , code);
                }
            }
        }
        ...
        WxLoginVerifyUtil.isNotEmpty(wxLoginResultDTO.getSession_key() , WxLoginExceptionEnums.LOGIN_REQUIRED_LOGIN_SESSION_NULL , code);
